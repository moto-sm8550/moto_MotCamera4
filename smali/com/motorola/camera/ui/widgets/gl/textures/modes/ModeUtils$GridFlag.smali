...
.method public static constructor <clinit>()V
    ...
    const-string v3, "MENU_TOUCH_DOWN"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "DONE_TOUCH_DOWN"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;->DONE_TOUCH_DOWN:Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;

    .line 4
    new-instance v5, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;

    const-string v7, "LIST_MOVING"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;->LIST_MOVING:Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;

    .line 5
    new-instance v7, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;

    const-string v9, "LIST_LONG_PRESS"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;->LIST_LONG_PRESS:Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;

    .line 6
    new-instance v9, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;

    const-string v11, "CELL_MOVING"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;->CELL_MOVING:Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;

    .line 7
    new-instance v11, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;

    const-string v13, "CELL_OUT_SLIDER"

    const/4 v14, 0x6

    invoke-direct {v11, v13, v14}, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;-><init>(Ljava/lang/String;I)V

    const/4 v13, 0x7

    new-array v13, v13, [Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;
    ...
    .line 8
    sput-object v13, Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;->$VALUES:[Lcom/motorola/camera/ui/widgets/gl/textures/modes/ModeUtils$GridFlag;
